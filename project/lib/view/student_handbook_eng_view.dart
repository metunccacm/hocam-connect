            ...
            onSelect: (code) {
              if (code == 'TR') {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                      builder: (_) => const StudentHandbookTrView()),
                );
              }
            },
          ),
      ...
      body: ListView(
        ...
        children: [
          ...
          _section(
            ...
            children: [
              const _Bullet(
                  "Dorm 2 is the first one you’ll notice right in front of the bus stop."
              ...
              _Bullet(
                  "EBI is the newest dorm on campus, located behind Dorms 2 and 3."
              ...
              _Bullet(
                  "Dorm 4 is a bit further away, near the top gate of the campus."
              ...
              const _Bullet(
                  "Dorm staff help with check‑in any time—just ask security."),
            ],
          ),
          _section(
            context,
            ...
            children: [
              const _Bullet(
                  "Back at the bus stop, you’ll notice stairs leading up to the Macro supermarket."
              ...
              _Bullet(
                  "If you keep walking, you’ll find a small street where the campus barber and hairdresser are located."
              ...
              _Bullet(
                  "Right next to Deniz Plaza, you’ll find the tailor and the KKTCELL service point."
          ...
          _section(
            ...
            children: [
              const _Bullet(
                  "If you lose something or need to check with campus security, their office is located between the entrances of the Main Cafeteria and the Patisserie."
          ...
          _section(
            ...
            children: [
              const _Bullet(
                  "Our university provides wireless internet throughout the campus, but to use it you need to register your devices at the Information Technologies (IT) building."
              ...
              _linkTile(
                ...
                url:
                    'https://ncc.metu.edu.tr/sites/default/files/RegistrationofElectronicDevices2022-23.pdf',
              ),
              _linkTile(
                context,
                label: 'IT website',
          ...
          _section(
            ...
            children: [
              const _Bullet(
                  "Next to the IT building is the Library, one of the most important places on campus."
          ...
          _section(
            ...
            children: [
              const _Bullet(
                  "Right next to the Library is the Rector’s Building, which also houses Student Affairs."
          ...
          _section(
            ...
            children: [
              const _Bullet(
                  "Back near the Main Cafeteria, you’ll notice stairs leading down to the Prep School building."
              ...
              const _Bullet(
                  "The T (Teaching) Building is where you’ll find lecture halls and a small café."
              ...
              const _Bullet(
                  "Classrooms are coded by building, floor, and room number."
            ...
            footerLinks: [
              _FooterLink('More about the School of Foreign Languages',
                  'https://ncc.metu.edu.tr/sfl/general-info'),
            ],
          ),
          _section(
            context,
            ...
            children: [
              const _Bullet(
                  "Following the road from the bus stop, you’ll see Medico, the campus health center, located across from the football field."
            ...
            footerLinks: [
              _FooterLink('More about Medico',
                  'https://www.youtube.com/embed/ek3Jh-1xt78?rel=0'),
              _FooterLink('More about the Sports',
                  'https://ncc.metu.edu.tr/campus-life/sports-mission'),
            ],
          ),
          _section(
            context,
            ...
            children: [
              _BulletInline([
                const TextSpan(
                    text:
                        "There are two cards you’ll need on campus: the student card and the copycard. "),
                const TextSpan(
                    text:
                        "Your student card is essential for using the buses and can be loaded with credits online at "),
                TextSpan(
                  text: 'cyppass.com',
                  style: TextStyle(
                  ...
                  recognizer: TapGestureRecognizer()
                    ..onTap =
                        () => _openUrl(context, 'https://www.cyppass.com/tr'),
                ),
          ...
          _section(
            ...
            children: [
              const _Bullet(
                  "The local bus system connects the campus with Kalkanlı and Güzelyurt."
              ...
              const _Bullet(
                  "Copycard: for printing in dorms/Library; buy and load at the Library."),
            ],
          ),
          _section(
            context,
          ...
          _section(
            ...
            children: [
              const _Bullet(
                  "One of the most popular spots is Segafredo Tchibo Café, located just under the Atatürk statue near the bus stop."
          ...
          _section(
            ...
            children: [
              const _Bullet(
                  "In front of the Science Tree statue, next to the Prep School, is the CCC Building, the main venue for campus events."
              ...
              _Bullet(
                  "A cozy and futuristic restaurant/café is located at the bottom floor of Kaltev, called Root."
            ...
            child: RichText(
              text: TextSpan(
                style: DefaultTextStyle.of(context)
                    .style
                    .merge(const TextStyle(height: 1.35, fontSize: 14)),
                children: spans,
              ),
            ),
          ),
